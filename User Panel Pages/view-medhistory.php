...
<head>
    ...
    <link rel="icon" type="images/png" href="../healhub/assets/images/favicon2.png">
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15"> <span class="text-bold">Medical
                                        History</span></h5>
                                <?php
                               $vid=$_GET['viewid'];
...
while ($row=mysqli_fetch_array($ret)) {
                               ?>
                                <table border="1" class="table table-bordered">
                                    <tr align="center">
                                        <td colspan="4" style="font-size:20px; font-weight:600;">
                                            Patient Details</td>
                                    </tr>
