...
if (strlen($_SESSION['id'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO services (specilization, spec_description, spec_image) VALUES ('$specilization', '$spec_description' , '$spec_image' )";
    ...
    if (($result)) {
      ...
      echo "<script>alert('Error in adding service');</script>";
    }
  }
?>
  <!DOCTYPE html>
        ...
        <div class="main-content">
          <div class="wrap-content container" id="container">
            ...
            <section id="page-title">
              <div class="row">
                <div class="col-sm-8">
                  <h1 class="mainTitle">Admin | Add Services</h1>
                </div>
                <ol class="breadcrumb">
                  <li>
                    <span>Admin</span>
                      ...
                      <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                          <form action="add-services.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="specilization" class="name" placeholder="Service Name Name" required><br>
                            <label>Description</label><br>
                            <textarea name="spec_description" class="description" placeholder="Service Decsription" required></textarea><br>
                            <label>Upload Image</label><br>
                            <input type="file" name="spec_image" class="image" required><br><br>
  ...
  //create a form that container user name user paswword and user image submit to database
