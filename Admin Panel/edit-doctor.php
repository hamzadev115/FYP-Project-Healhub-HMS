...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "Update doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' , docimage='$docimage' where id='$did'");
        if ($sql) {
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 style="color: black; font-size:18px; font-weight: 500; font-family: 'Montserrat'; ">
                                    <?php if ($msg) {
